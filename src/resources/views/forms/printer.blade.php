        ...
        <div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="serialNumber" name="serialNumber"
                       placeholder="Numéro de série" required onkeydown="keyDown(event)">
            </div>
            <div class="form-group">
                <label for="cti">CTI</label>
                <input type="text" class="form-control" id="cti" name="cti" placeholder="CTI" required minlength="6"
                       maxlength="6" onkeydown="keyDown(event)">
            </div>
