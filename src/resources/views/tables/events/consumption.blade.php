    ...
    <div class="py-12 overflow-hidden">
        ...
        <div class="w-50 p-3 float-end card card-block card-stretch card-height">
            <div class="d-inline-flex mb-2">
                <label for="author" class="h-100 mt-auto mb-auto">Utilisateur : </label>
                <input type="text" class="form-control ms-1" placeholder="Rechercher..." id="author" name="author"
                       style="max-width: 370px;" oninput="searchChanged(this)">
            </div>
            <div class="d-inline-flex mb-2">
                <label for="printerCti" class="h-100 mt-auto mb-auto">Imprimante CTI : </label>
                <input type="text" class="form-control ms-1" placeholder="Rechercher..." id="printerCti"
                       name="printerCti" style="max-width: 370px;" oninput="searchChanged(this)">
            </div>
            <div class="d-inline-flex">
                <label for="supply" class="h-100 mt-auto mb-auto">Consommable : </label>
                <input type="text" class="form-control ms-1" placeholder="Rechercher..." id="supply" name="supply"
                       style="max-width: 370px;" oninput="searchChanged(this)">
            </div>
